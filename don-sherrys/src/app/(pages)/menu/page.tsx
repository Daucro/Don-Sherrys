    ...
    <main>
      <Paper elevation={14}>
        <Box>
          ...
          >
            It is <b>important</b> to us to provide food that is delicious,
            wholesome and meets your needs. In order to do so any dietary
            ...
            of time to plan ahead of time if any special requirements need to be
            met. We do not currently offer Lunch meals. Meals are posted weekly
            at the residence using a calendar.
          </Typography>
        </Box>
        <div>
        ...
        <p>
          *Substitutions can be made for ex: Toast instead of biscuits. Sausage
          instead of Bacon.*
        </p>
        <div>
          <Typography className="Center" variant="h2">
        ...
        <p>
          *Dinner is served with side dishes.Sides include but are not limited
          to fries, mashed potatoes, baked potatoes, green beans, asparagus,
