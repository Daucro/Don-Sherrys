    ...
    <main>
      <Box>
        ...
        >
          ...
          met. We do not currently offer Lunch meals. Meals are posted weekly at
          the residence using a calendar.
        </Typography>
      </Box>
      <div>
      ...
      <p>
        *Dinner is served with side dishes.Sides include but are not limited to
        fries, mashed potatoes, baked potatoes, green beans, asparagus, corn,
        rolls, rice, and side salad*
      </p>
      <Container
        sx={{
          padding: "15px",
